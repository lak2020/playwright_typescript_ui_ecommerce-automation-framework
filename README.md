...
| 📊 Allure Report (GitHub Pages) | [Live Report](https://lak2020.github.io/playwright_typescript_ui_ecommerce-automation-framework/) |
...
```
playwright_typescript_ui_ecommerce-automation-framework/
├── .github/
│   └── workflows/
...
git clone https://github.com/lak2020/playwright_typescript_ui_ecommerce-automation-framework.git
cd playwright_typescript_ui_ecommerce-automation-framework
